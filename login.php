...
$uname=strtoupper($uname);
	$qry=mysql_query("select * from md_patient where uname='$uname' && pass='$pass'");
  ...
  <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
	...
	<section id="contact" class="section-padding">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h2 class="ser-title">Patient</h2>
					<hr class="botm-line">
				</div>
				<div class="col-md-4 col-sm-4">
			      <!--<h3></h3>-->
			      <div class="space"><img src="img/thumb.png" width="218" height="190"></div>
			     
			      
			    </div>
				<div class="col-md-8 col-sm-8 marb20">
					<div class="contact-info">
							<h3 class="cnt-ttl">Patient Login</h3>
							<div class="space"></div>
                            <div id="sendmessage">Your message has been sent. Thank you!</div>
                            <div id="errormessage"></div>
							<form name="form1" action="" method="post" role="form" class="contactForm">
							    <div class="form-group">
                                    <input type="text" name="uname" class="form-control br-radius-zero" id="uname" placeholder="Patient ID" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
